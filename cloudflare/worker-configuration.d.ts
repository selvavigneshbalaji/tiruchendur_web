/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=cloudflare/wrangler.jsonc cloudflare\worker-configuration.d.ts` (hash: 353e1042872eb8a653ceb3e3c9902f3c)
// Runtime types generated with workerd@1.20260820.1 2026-08-22 
interface __BaseEnv_Env {
	PHOTOS: R2Bucket;
	DB: D1Database;
	APP_ORIGIN: "https://www.tiruchendurstay.in";
	COOKIE_DOMAIN: ".tiruchendurstay.in";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ORIGIN" | "COOKIE_DOMAIN">> {}
}
